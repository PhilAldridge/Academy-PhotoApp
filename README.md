...
1. Open VS Code
2. Click on Terminal to open a new terminal using **WSL** (NOTE: You will need to do this in WSL to get hot reload to work)
...
7. Open a new terminal in VS Code make sure the terminal is **Ubuntu (WSL)** (to the right of the Powershell text, click the down arrow next to the plus sign to select)
8. Navigate to the **hack-day-1-boilerplate** folder if you are not in it
